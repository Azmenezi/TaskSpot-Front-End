...
with_node --no-warnings --eval "require('expo-modules-autolinking')(process.argv.slice(1))" generate-package-list  --target "/Users/azizan/Desktop/code/React Native FullStack/TaskSpot/TaskSpot-Front-End/ios/Pods/Target Support Files/Pods-TaskSpot/ExpoModulesProvider.swift"
